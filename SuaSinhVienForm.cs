...
{
    public class SuaSinhVienForm : Form
    {
        ...
        public SuaSinhVienForm(string currentMaSV, string currentTenSV, string currentLop, string currentGioiTinh, string currentNgaySinh)
        {
            ...
            txtMaSV = new TextBox() { Font = new Font("Segoe UI", 10.5f), Text = currentMaSV, ReadOnly = true, BackColor = ColorTranslator.FromHtml("#EDF2F7") };
            CreateRoundedControl(txtMaSV, 25, 100, 410, 36);

            // Tên SV
            AddLabel("HỌ VÀ TÊN *", 25, 153);
            txtTenSV = new TextBox() { Font = new Font("Segoe UI", 10.5f), Text = currentTenSV };
            ...
            if (!cbLop.Items.Contains(currentLop))
            {
                cbLop.Items.Add(currentLop);
            }
            cbLop.SelectedItem = currentLop;
            ...
            if(cbGioiTinh.Items.Contains(currentGioiTinh))
                cbGioiTinh.SelectedItem = currentGioiTinh;
            else
            ...
            txtNgaySinh = new TextBox() { Font = new Font("Segoe UI", 10.5f), Text = currentNgaySinh };
