...
{
    public class ThemGiangVienForm : Form
    {
        ...
        public ThemGiangVienForm()
        {
            ...
            lblTitle.Text = "Thêm Giảng Viên Mới";
            ...
            txtMaGV = new TextBox() { Font = new Font("Segoe UI", 10.5f) };
            CreateRoundedControl(txtMaGV, 25, 100, 410, 36);

            // Tên GV
            AddLabel("HỌ VÀ TÊN *", 25, 153);
            txtTenGV = new TextBox() { Font = new Font("Segoe UI", 10.5f) };
